...
@Slf4j
public abstract class AbstractSerializeModifier extends BeanSerializerModifier {
    @Override
    ...
    protected abstract FieldTranslation getFieldTranslation(Class<?> targetType);
